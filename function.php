...
function battle($user, $ally)
{
  ...
  if ($user !== $ally) {
    if (($user === pattern::ROCK && $ally === pattern::SCISSORS)) {
      ...
      Sentence::clear();
      Sentence::resultSet('You chose Rock and ' . $_SESSION['ally']->getName() . ' chose Scissors.<BR>You won.<BR>Press continue to next.');
      ...
      $_SESSION["user"]->addToAttackPoints($_SESSION['ally']->getAttackPoints());
      Sentence::clear();
      Sentence::resultSet('You chose Paper and ' . $_SESSION['ally']->getName() . 'chose Rock.<BR>You won.<BR>Press continue to next.');
      ...
      $_SESSION["user"]->addToAttackPoints($_SESSION['ally']->getAttackPoints());
      Sentence::clear();
      Sentence::resultSet('You chose Scissors and ' . $_SESSION['ally']->getName() . ' chose Paper.<BR>You won.<BR>Press continue to next.');
      ...
      Sentence::clear();
      Sentence::resultSet('You chose Rock and ' . $_SESSION['ally']->getName() . ' chose Paper.<BR>You lost.<BR>Press continue to next.');
      ...
      $_SESSION['user']->minusLifeCount();
      Sentence::clear();
      Sentence::resultSet('You chose Paper and ' . $_SESSION['ally']->getName() . ' chose SCISSORS.<BR>You lost.<BR>Press continue to next.');
      ...
      $_SESSION['user']->minusLifeCount();
      Sentence::clear();
      Sentence::resultSet('You chose Scissors and ' . $_SESSION['ally']->getName() . ' chose ROCK.<BR>You lost.<BR>Press continue to next.');
      $_SESSION['battleFlg'] = 'lose';
      Sentence::allyAndBossSet($_SESSION['ally']->getName(), $_SESSION['ally']->allyWin());
    }
  } else {
